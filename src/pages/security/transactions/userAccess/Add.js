...
const Add = () => {
    ...
    return (_jsxs("div", { className: "_rkContentBorder container-fluid py-3 ", style: { border: "1px solid black", marginTop: "7px", marginBottom: "70px" }, children: [_jsx("div", { className: "d-flex justify-content-between align-items-center text-white px-3 py-1 mb-3 fw-bold", style: { backgroundColor: "#023e8a" }, children: _jsx("span", { style: { fontSize: "12px" }, children: "\uD83D\uDC49 User Access >> Add" }) }), _jsxs("form", { onSubmit: handleFormSubmit, children: [_jsx("div", { className: "row", children: _jsx(RowFormSelectField, { name: "username", label: "User Name", isLoading: userLoading, options: userList, value: formData.username, onChange: handleSelectChange, isEdit: true, error: errors.username, required: true, 
                            ...
                            formData: formData, row: "col-md-5", col1: "col-md-3", col2: "col-md-9" }) }), _jsx("div", { className: "row mt-3", children: _jsx("div", { className: "col-12", children: _jsxs("div", { style: { overflowX: "auto" }, children: [_jsxs("table", { className: "custom-table table-bordered table-sm", children: [_jsx("thead", { className: "text-white", children: _jsxs("tr", { children: [_jsx("th", { children: "Modules" }), _jsx("th", { children: "Menus" }), _jsxs("th", { style: { width: "15%" }, children: ["Allow Access", menuRows.length > 0 && _jsx("input", { ref: selectAllRef, type: "checkbox", className: "form-check-input pl-5", style: {
                                                                        ...
                                                                        menuRows.every(row => row.isChecked), onChange: (e) => handleSelectAll(e.target.checked) })] })] }) }), _jsxs("tbody", { children: [menuRows?.length === 0 && (_jsx("tr", { children: _jsx("td", { colSpan: 12, className: "text-center", children: "No menus" }) })), menuRows && menuRows?.map((row, index) => (_jsxs("tr", { children: [_jsxs("td", { children: [" ", _jsx("input", { readOnly: true, style: { height: "23px", fontSize: "10px", fontWeight: "bold" }, value: row.moduleName ?? "", className: `form-control custom-form-control` }), "  "] }), _jsxs("td", { children: [" ", _jsx("input", { readOnly: true, style: { height: "23px", fontSize: "10px", fontWeight: "bold" }, value: row.menuNameTree ?? "", className: `form-control custom-form-control` }), "  "] }), _jsx("td", { className: "text-center align-middle", children: row?.leaf == 1 && _jsx("input", { type: "checkbox", className: "form-check-input", disabled: !row?.leaf, style: {
                                                                        marginLeft: "37px",
                                                                        borderRadius: "0px",
                                                                        transform: "scale(1.4)",
                                                                        cursor: "pointer",
                                                                        border: "1px solid #023e8a",
                                                                    }, checked: !!row.isChecked, onChange: (e) => handleRowChange(index, "isChecked", row) }) })] }, row.menuId)))] })] }), loading && _jsx(LoadingFetchLoader, {})] }) }) }), _jsxs("div", { className: "d-flex gap-3 justify-content-end", children: [_jsx("button", { type: "button", disabled: submitting, className: "btn btn-sm btn-secondary custom-form-control", onClick: () => navigate("/editUserAccess"), children: "Back to Search Page" }), _jsxs("button", { type: "submit", className: `btn btn-success btn-sm px-4 custom-form-control position-relative ${submitting ? "loading" : ""}`, disabled: submitting, style: {
                                    minWidth: "100px"
                                }, children: [submitting && _jsx("span", { className: "spinner-center" }), !submitting && _jsx("span", { className: "btn-text", children: "Submit" })] })] })] })] }));
};
export default Add;
