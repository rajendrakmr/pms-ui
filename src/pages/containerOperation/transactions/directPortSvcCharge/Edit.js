...
const Edit = ({ setIsEdit, apiRequest, initialForm, setInitialForm }) => {
    ...
    const handleRazorpayPayment = async () => {
        ...
        const confirmPayment = window.confirm(`Confirm payment of ₹${totalAmount}?`);
        if (!confirmPayment)
            return;
        try {
            const options = {
