...
const RowFormInputField = memo(({ label, placeholder, type = 'text', name, inputValue, onChange, error, isDefault = false, onBlur, required = false, max = 250, onKeyUp, row = "col-md-4", col1 = "col-sm-5 col-4", col2 = "col-sm-7 col-8" }) => {
